...
Pod::Spec.new do |spec|
  ...
  这个是UNAD全球版本.的cocoapods
                   DESC

  spec.homepage     = "https://github.com/adgocompany/unad-ios-all"
  ...
  spec.source       = { :git => "https://github.com/adgocompany/unad-ios-all.git", :tag => "#{spec.version}" }
  ...
  #
   ...
   spec.resource  = "UNAD-All/UNADBundle.bundle"
